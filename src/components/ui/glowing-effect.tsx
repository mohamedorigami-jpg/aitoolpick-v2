...
/**
 * GlowingEffect — creates a glowing border that follows the mouse cursor
 * around the card edge. Adapted from 21st.dev/aceternity.
 */
    ...
    const handleMove = useCallback(
      (e?: MouseEvent | { x: number; y: number }) => {
        ...
        animationFrameRef.current = requestAnimationFrame(() => {
          ...
          // Simple animation without motion/react animate
          ...
          const animateAngle = (now: number) => {
            ...
            const value = startAngle + (endAngle - startAngle) * eased;
